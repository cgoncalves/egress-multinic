...
SCRIPT_FILE="${SCRIPT_DIR}/egress-multinic-reconciler.sh"
CONFIG_FILE="${SCRIPT_DIR}/egress-multinic.conf"
TEMPLATE_FILE="${SCRIPT_DIR}/machineconfig-egress-multinic.yaml"
OUTPUT_FILE="${SCRIPT_DIR}/machineconfig-egress-multinic-final.yaml"
CA_FILE=""
TOKEN_FILE=""
