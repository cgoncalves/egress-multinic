...
# and token Secret used by the egress-multinic reconciler.
#
...
SA_NAME="egress-multinic"
SECRET_NAME="egress-multinic-token"
CLUSTERROLE_NAME="egress-multinic-node-reader"
CLUSTERROLEBINDING_NAME="egress-multinic-node-reader"
OUTPUT_DIR=""
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
CONFIG_FILE="${SCRIPT_DIR}/egress-multinic.conf"
...
usage() {
  ...
  echo "  delete  Remove all egress-multinic SA resources"
  echo ""
...
delete() {
  echo "Deleting egress-multinic SA resources..."
